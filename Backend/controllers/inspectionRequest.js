...
const saveInspectionRequest = async (req, res) => {
    ...
    const { modelName, IMEI, date, status } = req.body;
    await InspectionRequest.create({ userId, productId, modelName, IMEI, date, status });
...
const updateInspectionRequest = async (req, res) => {
  ...
  await inspectionRequest.update({  modelName, IMEI, date, status });
